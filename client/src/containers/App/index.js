...
const App = () => {
    ...
    return (
        <>
            ...
            {(window.location.href.includes("www.allweatherhiviz.com")) ? <AllWeaherHighViz auth={auth} screenWidth={width} /> : null}
            ...
            {(window.location.href.includes("www.offsoundings.store")) || window.location.href.includes("localhost") ? <OffSoundings auth={auth} screenWidth={width} /> : null}
        </>
    );
};
